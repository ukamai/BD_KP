...
ALTER TABLE property_rooms  ADD  CONSTRAINT fk_rooms_property FOREIGN KEY (property_id) REFERENCES properties(property_id) ON DELETE CASCADE;

ALTER TABLE contracts       DROP CONSTRAINT IF EXISTS fk_contracts_property;
ALTER TABLE contracts       ADD  CONSTRAINT fk_contracts_property FOREIGN KEY (property_id) REFERENCES properties(property_id) ON DELETE RESTRICT;

ALTER TABLE contracts       DROP CONSTRAINT IF EXISTS fk_contracts_contractor;
ALTER TABLE contracts       ADD  CONSTRAINT fk_contracts_contractor FOREIGN KEY (contractor_id) REFERENCES contractors(contractor_id) ON DELETE RESTRICT;

ALTER TABLE projects        DROP CONSTRAINT IF EXISTS fk_projects_property;
ALTER TABLE projects        ADD  CONSTRAINT fk_projects_property FOREIGN KEY (property_id) REFERENCES properties(property_id) ON DELETE RESTRICT;

ALTER TABLE projects        DROP CONSTRAINT IF EXISTS fk_projects_contract;
ALTER TABLE projects        ADD  CONSTRAINT fk_projects_contract FOREIGN KEY (contract_id) REFERENCES contracts(contract_id) ON DELETE SET NULL;

ALTER TABLE project_phases  DROP CONSTRAINT IF EXISTS fk_phases_project;
ALTER TABLE project_phases  ADD  CONSTRAINT fk_phases_project FOREIGN KEY (project_id) REFERENCES projects(project_id) ON DELETE CASCADE;

ALTER TABLE project_tasks   DROP CONSTRAINT IF EXISTS fk_tasks_project;
ALTER TABLE project_tasks   ADD  CONSTRAINT fk_tasks_project FOREIGN KEY (project_id) REFERENCES projects(project_id) ON DELETE CASCADE;

ALTER TABLE project_tasks   DROP CONSTRAINT IF EXISTS fk_tasks_phase;
ALTER TABLE project_tasks   ADD  CONSTRAINT fk_tasks_phase FOREIGN KEY (phase_id) REFERENCES project_phases(phase_id) ON DELETE RESTRICT;

ALTER TABLE project_tasks   DROP CONSTRAINT IF EXISTS fk_tasks_room;
ALTER TABLE project_tasks   ADD  CONSTRAINT fk_tasks_room FOREIGN KEY (room_id) REFERENCES property_rooms(room_id) ON DELETE SET NULL;

ALTER TABLE project_tasks   DROP CONSTRAINT IF EXISTS fk_tasks_work_type;
ALTER TABLE project_tasks   ADD  CONSTRAINT fk_tasks_work_type FOREIGN KEY (work_type_id) REFERENCES work_types(work_type_id) ON DELETE RESTRICT;

ALTER TABLE project_tasks   DROP CONSTRAINT IF EXISTS fk_tasks_contractor;
ALTER TABLE project_tasks   ADD  CONSTRAINT fk_tasks_contractor FOREIGN KEY (contractor_id) REFERENCES contractors(contractor_id) ON DELETE SET NULL;

ALTER TABLE acceptance_acts DROP CONSTRAINT IF EXISTS fk_acceptance_task;
ALTER TABLE acceptance_acts ADD  CONSTRAINT fk_acceptance_task FOREIGN KEY (task_id) REFERENCES project_tasks(task_id) ON DELETE CASCADE;

ALTER TABLE purchase_orders DROP CONSTRAINT IF EXISTS fk_orders_project;
ALTER TABLE purchase_orders ADD  CONSTRAINT fk_orders_project FOREIGN KEY (project_id) REFERENCES projects(project_id) ON DELETE CASCADE;

ALTER TABLE purchase_orders DROP CONSTRAINT IF EXISTS fk_orders_supplier;
ALTER TABLE purchase_orders ADD  CONSTRAINT fk_orders_supplier FOREIGN KEY (supplier_id) REFERENCES suppliers(supplier_id) ON DELETE RESTRICT;

ALTER TABLE purchase_order_items DROP CONSTRAINT IF EXISTS fk_po_items_po;
ALTER TABLE purchase_order_items ADD  CONSTRAINT fk_po_items_po FOREIGN KEY (po_id) REFERENCES purchase_orders(po_id) ON DELETE CASCADE;

ALTER TABLE purchase_order_items DROP CONSTRAINT IF EXISTS fk_po_items_material;
ALTER TABLE purchase_order_items ADD  CONSTRAINT fk_po_items_material FOREIGN KEY (material_id) REFERENCES materials(material_id) ON DELETE RESTRICT;

ALTER TABLE inventory_transactions DROP CONSTRAINT IF EXISTS fk_inv_project;
ALTER TABLE inventory_transactions ADD  CONSTRAINT fk_inv_project FOREIGN KEY (project_id) REFERENCES projects(project_id) ON DELETE CASCADE;

ALTER TABLE inventory_transactions DROP CONSTRAINT IF EXISTS fk_inv_material;
ALTER TABLE inventory_transactions ADD  CONSTRAINT fk_inv_material FOREIGN KEY (material_id) REFERENCES materials(material_id) ON DELETE RESTRICT;

ALTER TABLE inventory_transactions DROP CONSTRAINT IF EXISTS fk_inv_task;
ALTER TABLE inventory_transactions ADD  CONSTRAINT fk_inv_task FOREIGN KEY (task_id) REFERENCES project_tasks(task_id) ON DELETE SET NULL;

ALTER TABLE inventory_transactions DROP CONSTRAINT IF EXISTS fk_inv_po_item;
ALTER TABLE inventory_transactions ADD  CONSTRAINT fk_inv_po_item FOREIGN KEY (po_item_id) REFERENCES purchase_order_items(po_item_id) ON DELETE SET NULL;

ALTER TABLE defects DROP CONSTRAINT IF EXISTS fk_defects_task;
ALTER TABLE defects ADD  CONSTRAINT fk_defects_task FOREIGN KEY (task_id) REFERENCES project_tasks(task_id) ON DELETE CASCADE;

ALTER TABLE defects DROP CONSTRAINT IF EXISTS fk_defects_contractor;
ALTER TABLE defects ADD  CONSTRAINT fk_defects_contractor FOREIGN KEY (contractor_id) REFERENCES contractors(contractor_id) ON DELETE SET NULL;
